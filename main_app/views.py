from urllib.parse import urlsplit, urlunsplit #delete this line

from django.conf import settings #delete this line
from django.contrib import messages #delete this line
from django.contrib.auth.decorators import login_required #delete this line
from django.db.models import Q #delete this line
from django.shortcuts import render, redirect, get_object_or_404
from django.http import HttpResponse, JsonResponse, Http404 #delete Http404
from django.urls import reverse #delete this line
from django.utils.decorators import method_decorator #delete this line
from .models import Topic, Post, Profile, Image, OPTION_MESSAGES, Message, get_order_by #delete OPTION_MESSAGES, Message, get_order_by
from .forms import Post_Form, Profile_Form, SignUpForm, Profile_User_Form, ImageForm, CommentForm, WriteForm, AnonymousWriteForm, QuickReplyForm, FullReplyForm #delete WriteForm, AnonymousWriteForm, QuickReplyForm, FullReplyForm
from django.contrib.auth import login, authenticate, get_user_model  #delete get_user_model
from django.contrib.auth.forms import UserCreationForm, AuthenticationForm
from django.contrib.auth.models import User
from django.contrib.auth.decorators import login_required
from django.contrib.sites.shortcuts import get_current_site
from django.utils.encoding import force_text, force_str #delete force_str
from django.utils.timezone import now #delete this line
from django.utils.translation import gettext as _, gettext_lazy #delete this line
...
from django.views.decorators.cache import never_cache #delete this line
from django.views.decorators.csrf import csrf_protect #delete this line
from django.views.decorators.debug import sensitive_post_parameters #delete this line
from django.views.generic import FormView, RedirectView, TemplateView, View #delete this line

from .fields import autocompleter_app #delete this line
from .tokens import account_activation_token
from .utils import format_subject, format_body #delete this line

login_required_m = method_decorator(login_required) #delete this line
csrf_protect_m = method_decorator(csrf_protect) #delete this line
never_cache_m = method_decorator(never_cache) #delete this line
sensitive_post_parameters_m = method_decorator(sensitive_post_parameters('subject', 'body')) #delete this line
...
def topics_detail(request, topic_id):
    ...
    post = Post.objects.all()
    post_form = Post_Form()
    context = {'login': AuthenticationForm(), 'post': post, 'signup': UserCreationForm(), 'topic': topic, 'topics': topics, 'post_form': post_form, 'posts': posts.order_by("created_at")}
