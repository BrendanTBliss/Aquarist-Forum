import hashlib #delete this line
from importlib import import_module #delete this line

from django.conf import settings #delete this line
from django.core.exceptions import ValidationError #delete this line
from django.db import models
from django.db.models import IntegerField, Value #delete this line
from django.db.models.expressions import RawSQL #delete this line
from django.db.models.query import QuerySet #delete this line
from django.urls import reverse #delete this line
from django.utils.encoding import force_str #delete this line
from django.utils.text import Truncator #delete this line
...
from django.views.decorators.debug import sensitive_variables #delete this line

from .query import PostmanQuery #delete this line
from .utils import email_visitor, notify_user #delete this line

#DELETE EVERYTHING BELOW THIS LINE AND ABOVE THE BELOW MENTION
# options
...
#DELETE EVERYTHING ABOVE THIS LINE UNTIL THE ABOVE MENTION
...
class Message(models.Model):
    ...
    sender = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='+', #should be sent_messages
        null=True, blank=True, verbose_name=_("sender"))
    recipient = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='+', #should be recieved_messages
    ...
    moderation_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, related_name='+', #should be moderated_messages
